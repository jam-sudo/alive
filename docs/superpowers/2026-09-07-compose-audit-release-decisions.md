...
|---|---|---|---|---|---|
| **D** | bias spec §1 — bridge representation 을 강제 계약으로, report v4 | Task 2 | (Task 2 Step 1) | (Task 2 Step 4) | SIGNED (오너 지시 2026-09-07) — PROPOSED text, effective when its task lands |
