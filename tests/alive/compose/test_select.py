...
def test_ridge_candidate_remains_viable_when_gram_addition_would_lose_lambda():
    """The SVD filter-factor solver removes the old scale-driven false rejection."""
    ...
    assert result.selected_lambda in {0.0, 0.001}
